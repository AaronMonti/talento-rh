    ...
    return (
      <input
        ...
        className={cn(
          ...
          // Brutalist variant
          variant === "brutalist" && [
            "border-[3px] border-black bg-white rounded-none focus:ring-0 focus:border-black focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] font-bold placeholder:text-gray-500 text-black"
          ],
